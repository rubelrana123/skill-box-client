	...
	<div className="container flex flex-col justify-center px-16 p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
		...
		<div className="flex flex-col justify-start p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
			...
			<div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
				<Link  to="/faq"   className="px-8 py-3 text-lg font-semibold rounded dark:bg-blue-600 dark:text-gray-900">GET START</Link>
				<Link rel="noopener noreferrer" to = "/" className="px-8 py-3 text-lg font-semibold border rounded border-blue-500">Learn More</Link>
			</div>
		</div>
	</div>
</section>
